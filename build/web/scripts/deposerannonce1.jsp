...
<a name="fb_share" type="button_count" share_url="<%= Datas.URLROOT %>">Cliquez pour partager !!!</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>
           ...
           <g:plusone></g:plusone>
           <br/>
           <h1>Potagers solidaires :: Déposer une annonce (identification)</h1>
           <%
           if(request.getAttribute("membre")!=null) {
               Membre membre=(Membre)request.getAttribute("membre");
               if(membre.getId()!=0) { %>
               <fieldset>
                   <legend>Connecté !</legend>
                   <br/>
                   <div>Membre connecté : <%= membre.getPseudoConnecte() %> &rarr; <a href="./deposer-une-annonce-2.html" title="C'EST MOI, JE CLIQUE !" rel="nofollow">C'EST MOI !</a></div>
                   <br/>
               </fieldset>
                   <br/>
                   <% }
                   if(membre.getTest()==0) {
                    %>
                   <fieldset>
                       <legend>Je suis déjà inscrit, je me connecte :</legend>
                       <div id="form1">
                           <%
                           ...
                           <form action="./deposer-une-annonce-1.html#form1" method="POST">
                               ...
                               <fieldset>
                                   ...
                                   <div id="form2">
                                       ...
                                       <form action="./deposer-une-annonce-1.html#form2" method="POST">
