 ...
 * @author pj
 */
public class EffaceAnnonce extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatch = request.getRequestDispatcher("./scripts/effaceannonce.jsp");
            dispatch.forward(request, response);
            /* TODO output your page here
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EffaceAnnonce</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EffaceAnnonce at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
