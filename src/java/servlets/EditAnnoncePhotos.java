...
public class EditAnnoncePhotos extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            RequestDispatcher dispatch = request.getRequestDispatcher("./scripts/editannoncephotos.jsp");
            dispatch.forward(request, response);
            /* TODO output your page here
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditAnnoncePhotos</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditAnnoncePhotos at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
