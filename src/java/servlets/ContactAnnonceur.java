    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(idMembre==0)
                ...
                message.initContact(idAnnonce, idMembre);
            ...
            RequestDispatcher dispatch = request.getRequestDispatcher("./scripts/contactannonceur.jsp");
            dispatch.forward(request, response);
            /* TODO output your page here
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ContactAnnonceur</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ContactAnnonceur at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
