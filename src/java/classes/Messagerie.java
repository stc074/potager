...
public class Messagerie extends Objet {
    ...
    public void calculNbMsgRecus(long idMembre) {
        ...
        try {
            ...
            prepare.setLong(1, this.getIdMembreDestinataire());
            ...
            this.idMembreDestinataire=0;
        } catch (SQLException ex) {
            Logger.getLogger(Messagerie.class.getName()).log(Level.SEVERE, null, ex);
            this.idMembreDestinataire=0;
        }
    }
    public void calculNbMsgEnvoyes(long idMembre) {
    ...
    public void effaceEnvoye(long idMessage, long idMembre) {
        this.id=idMessage;
        this.idMembreExpediteur=idMembre;
        try {
            Objet.getConnection();
