...
public class Mail {
    ...
    public void send() {
        try {
            ...
            email.setAuthenticator(new DefaultAuthenticator("noreply@potagers-solidaires.net", "paradize"));
            email.addTo(this.destinataireEmail, this.destinataireNom);
            email.setFrom("noreply@potagers-solidaires.net", "Potagers solidaires");
    ...
    public void initMailAnnonce1(String pseudo, String titreAnnonce, long idAnnonce) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
    ...
    this.contenu+="<br/>";
    this.contenu+="<div>Elle est visible à cette adresse : <a href=\""+Datas.URLROOT+"/annonce-"+idAnnonce+".html\">"+Datas.URLROOT+"/annonce-"+idAnnonce+".html</a></div>";
    this.contenu+="<br/>";
    ...
    public void initMailAnnonceModif1(String pseudo, String titreAnnonce, long idAnnonce) {
        this.contenu="<html";
        this.contenu+="<head>";
        this.contenu+="<style type=\"text/css\">";
        this.contenu+="body {";
    ...
    this.contenu+="<br/>";
    this.contenu+="<div>pour le traiter : <a href=\""+Datas.URLROOT+"/nimdo/AbusAdmin?idAbus="+idAbus+"\">"+Datas.URLROOT+"/nimdo/AbusAdmin?idAbus="+idAbus+"</a></div>";
    this.contenu+="<br/>";
    this.contenu+="<br/>";
    this.contenu+="<br/>";
    this.contenu+="<div class=\"info\">Ceci est un mail automatique, inutile d'y répondre.</div>";
